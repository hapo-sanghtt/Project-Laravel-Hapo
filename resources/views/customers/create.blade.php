                ...
                <div class="card card-secondary">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="projects_id" id="projects_id" class="form-control"
                                   placeholder="ID project" onchange="validate()" onkeypress="validate()">
                        </div>
                    </div>
                </div>
            </div>
