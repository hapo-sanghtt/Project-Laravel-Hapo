        ...
        <div class="row">
            <div class="col-sm-8 offset-sm-2">
                ...
                @if ($errors->any())
                    ...
                    <br />
                @endif
                <form method="post" action="{{ route('members.update',$customers->id)}}">
                    @method('PATCH')
                    @csrf
                    ...
                    <div class="form-group">
                        <label for="project_id">ID member</label>
                        <input type="text" class="form-control" name="member_id" value="{{$customers->member_id}}"/>
                    </div>
                    <div class="form-group">
                        <label for="project_id">ID project</label>
                        <input type="text" class="form-control" name="project_id" value="{{$customers->project_id}}"/>
                    </div>
