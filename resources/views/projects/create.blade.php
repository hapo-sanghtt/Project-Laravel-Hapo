                ...
                <div class="col-md-6">
                    <div class="card card-secondary">
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" autocomplete="off" class="datepicker-here" id="start_date" data-language='en' data-position='bottom left'/>
                            </div>
                        </div>
                        <div class="form-group">
                            <strong>End date:</strong>
                            <div class="col-md-6">
                                <input type="text" autocomplete="off" class="datepicker-here" id="end_date" data-language='en' data-position='bottom left'/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="customers_id" id="customers_id" class="form-control" placeholder="ID customer" onchange="validate()" onkeypress="validate()">
                            </div>
                        </div>
                    </div>
                </div>
