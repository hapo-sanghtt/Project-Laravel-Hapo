    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8 offset-sm-2">
                ...
                <div class="form-group">
                    <strong for="member_id">ID member:</strong>
                    <p type="text" class="form-control">{{ $projects->member_id}}</p>
                </div>
                <div class="form-group">
                    <strong for="customer_id">ID customer:</strong>
                    <p type="text" class="form-control">{{ $projects->customer_id}}</p>
                </div>
